...
public class Servico {
    ...
    public void pesquisarServico(Banco db, String nomeServico, String cnpj) throws SQLException {
        String query = String.format("SELECT * FROM Servico WHERE nome_servico = '%s' and barbearia = '%s'", nomeServico, cnpj); //Pesquisa uma mesa na tabela de um restaurante específico
    ...
    public String toString() {
        return "Servico [nomeServico=" + nomeServico + ", valorServico=" + valorServico + "]";
    }
}